...
module.exports = (commController) => {
    ...
    router.post('/production/:prod_id/comments',[
        body('comment', "Коммент должен быть больше 25").isLength({min:25}),
        body('rating', "Рейтинг должен быть от 0 до 5").custom(value => validateRating(value))
